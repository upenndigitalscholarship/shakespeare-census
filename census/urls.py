...
urlpatterns = [
    ...
    path('contact/contact_success/', views.display_contact_success, name='contact_success'),
    ...
    # ...and ajax call
    path('admin_verify_location_verified', views.admin_verify_location_verified, name='admin_verify_location_verified'),

    # Edit verification and submission verification pages:
    path('admin_edit_verify', views.admin_edit_verify, name='admin_edit_verify'),
    path('admin_submission_verify', views.admin_submission_verify, name='admin_submission_verify'),
    # ...and ajax calls
    path('admin_verify_single_edit_accept/', views.admin_verify_single_edit_accept, name='admin_verify_single_edit_accept'),
    path('admin_verify_single_edit_reject/', views.admin_verify_single_edit_reject, name='admin_verify_single_edit_reject'),
    ...
    path('updatedraftcopy/<int:id>/', views.update_draft_copy, name='update_draft_copy'),
